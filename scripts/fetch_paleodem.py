#!/usr/bin/env python3
"""Fetch or verify the pinned PaleoDEM archives (Scotese & Wright 2018, CC BY 4.0)."""
...
MANIFEST = ROOT / "sources/paleodem.json"
SOURCE_DIR = (ROOT / "data/sources/paleodem").resolve()
