...
- Scotese 자신의 PALEOMAP 회전 모델(2016)도 T&C와는 멀다. 425 Ma 아프리카에서 경도가 178°
  다르다. 반면 Merdith와는 306 Ma까지 12° 안이고, 그 이전에도 차이가 수십 도에 머문다.
  고생대 경도에서 T&C가 다른 두 모델과 갈라진다.
...
고지자기 기준틀 판이 따로 있다. 이 프로젝트가 가진 CEED6 회전 파일은 판 0번이 열점 기준틀과
진극 이동 보정으로 정의되므로 맨틀 기준틀 판으로 보인다. 이는 머리말에서 추론한 것이며,
두 판을 직접 대조하지는 않았다. 앞 인용에서 가리키는 두 글은 [Seton et al. 2023][seton2023]의 기술 총설과,
...
"O'Connor and Duncan 1990"(열점 흔적)과 "RDM interpolated" 같은 주석이 붙는다. 240~306 Ma 극은
위도가 0.0°로 적도 위에 놓이고, 그보다 오래된 극에는 "CRS"와 날짜만 있다. 고생대 경도를
무엇으로 정했는지는 적혀 있지 않다.

**Scotese 지도에 맞춘 최적 자전축 회전.** 5.1과 같은 방법이다.
...
356 Ma까지는 ±11° 안이고 390~514 Ma에서 −23~−56°다. 뷰어의 지도는 2002년판이고 회전 모델은
2016년판이라, 이 차이가 모델 개정 때문인지는 이 측정으로 가를 수 없다.

**같은 지점 비교.** PALEOMAP에서 Merdith를 뺀 값과, T&C(판 0번)에서 PALEOMAP을 뺀 값이다.

| 시대 | 판 | PALEOMAP − Merdith 경도 | 위도 | T&C − PALEOMAP 경도 | 위도 |
|---|---|---|---|---|---|
| 255 Ma | 아프리카 | −1.0° | −3.8° | −0.2° | +5.3° |
| 306 Ma | 아프리카 | −5.8° | −5.1° | −18.8° | +0.8° |
| 356 Ma | 아프리카 | +13.7° | +16.9° | −53.2° | −5.8° |
| 425 Ma | 아프리카 | +69.7° | +2.5° | +178.2° | +15.8° |
| 425 Ma | 북아메리카 | +50.1° | −4.8° | −89.7° | +17.0° |
| 425 Ma | 발티카 | +51.3° | −1.2° | −96.9° | +31.7° |
| 514 Ma | 아프리카 | +23.1° | +23.6° | +136.3° | +5.2° |
| 514 Ma | 북아메리카 | +59.1° | −13.0° | −75.9° | +12.8° |
| 514 Ma | 발티카 | +21.9° | +1.5° | −81.7° | +39.0° |

PALEOMAP과 Merdith의 차이는 306 Ma까지 경도 12° 안, 그 이전에는 20~70°다. T&C와 PALEOMAP의
차이는 306 Ma에 이미 약 20°이고 425 Ma에는 90~180°에 이른다. 세 모델 가운데 고생대 경도에서
T&C가 가장 멀리 떨어져 있다. PALEOMAP과 Merdith 사이에 남는 수십 도는 경도를 붙잡을 관측이 없는
시대에 모델끼리 흔히 생기는 불일치로 보인다.

T&C 판 1번 층의 위도에서 PALEOMAP 위도를 빼면 발티카는 425 Ma +0.7°, 514 Ma 0.0°로 거의 같다.
하지만 425 Ma 남아메리카 −20.9°, 514 Ma 아프리카 −21.5°처럼 크게 남는 곳도 있어서, Merdith와
비교할 때(5.3)만큼 고르게 줄지는 않는다.
...
| PALEOMAP 회전 모델(Scotese 2016) | 판 001 "Hot Spot to PMAG"는 항등 회전. 신생대 아프리카는 열점 흔적 문헌을 인용하고, 고생대 규칙은 적혀 있지 않다 | 회전 파일 주석(5.4) |
...
- Wagenaar, S. D. M., Vaes, B., and van Hinsbergen, D. J. J., 2025. Toward reconstructing mantle convection using a minimum-continent-motion reference frame. Journal of Geophysical Research: Solid Earth, 130, e2024JB030430. <https://doi.org/10.1029/2024JB030430>
