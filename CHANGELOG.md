...
시간축에 기후·생물 사건 ([wwolf 019](devlog/20260925_wwolf_019_event_markers.md))

- 슬라이더 위에 짧은 기후·생물 사건이 표시된다: 전체 시대에 13개(오르도비스기 말 빙하기·대멸종부터
  페름기 말 대멸종, 카닉절 다우 사건, PETM, 에오세–올리고세 전환, 마이오세 기후 최적기까지), 시간 창에
  최종 간빙기·최종 빙기 극대기·아프리카 습윤기. 색과 글자(W 습윤, D 건조, H 온난, C 한랭, I 빙하,
  A 무산소, X 멸종)로 종류를 구분하고, 누르면 그 시점으로 간다.
- 슬라이더가 사건 안에 있으면 아래에 이름·기간·한 문장 설명과 DOI 링크가 나온다. 지도의 간격보다 짧은
  사건에는 "모형 스냅숏이라 표면에 따로 보이지 않는다"는 주의를 붙인다. 나이는 ICS 층서표 v2024/12
  (더 정밀한 연대가 있으면 그것), 인용 30개는 Crossref에서 확인했다.

확인: 고도 격자(또는 아틀라스) → 전체 시대. 슬라이더 위의 **X**(252 Ma 근처)를 누르면 페름기 말 대멸종으로
가고 아래에 설명이 나온다. 시간 범위 "최근 13만 년"에서는 최종 간빙기·최종 빙기 극대기·아프리카 습윤기.
