...
- [wwolf P02 — 해류: 현재에서 캄브리아기까지, 자료와 잠재 해류 계산](20260923_wwolf_P02_ocean_currents.md)
...
- [jikhanjung 100 — 빙기 창 확장(#59) 검토: PaleoMIST 26–80 ka 빙상과 지각 침강](20260918_jikhanjung_100_glacial_window_paleomist_review.md)
...
v0.17.0에서는 현재 하천 경로와 호수 자료를 반영하고, 현재 2장·빙기 10장을 재생성했습니다(wwolf 011–012, jikhanjung 094).
...
v0.18.0은 지구 내부 패널에서 지각·맨틀과 위도·경도 절개를 함께 조절합니다.
날짜 변경선 횡단과 인도–아시아 프리셋을 지원하며 자료는 v0.17.0과 같습니다(095·096).

v0.18.1은 절개 뒷면 표시와 불투명도에 따른 지표 색 급변을 수정하고, 모든 지구본에서
pan·zoom·tilt를 사용할 수 있게 했다. 과학 자료는 바뀌지 않았다(097·098).

v0.19.0은 13만 년 창의 26–80 ka 빙상을 PaleoMIST 1.0 복원으로 바꾸고 창의 빙기 하천을
나이 기준으로 고른다. 해수면은 스택 그대로다(100·101·102).

v0.20.0은 두 시간 창에 Krapp et al. (2021)의 모형 식생·강수를 더한다. 녹색 사하라를
재현하지 못하는 모형임을 화면이 밝힌다(wwolf 013·103).

v0.21.0은 위치 핀을 더한다. 현재의 장소를 PALEOMAP 회전으로 시간축을 따라 옮기고 쌍별
거리를 적는다. 자료는 v0.20.0과 같다(wwolf 014·015, 105).
